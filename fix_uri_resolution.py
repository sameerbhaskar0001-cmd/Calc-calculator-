...
# For addVaultFile fallback queries
old_add_fallback = """                        val mediaCursor = contentResolver.query(
...
new_add_fallback = """                        val baseUri = when {
...
code = code.replace(old_add_fallback, new_add_fallback)
