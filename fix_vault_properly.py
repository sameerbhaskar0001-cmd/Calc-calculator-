...
# Replace the delete block in addVaultFile
old_delete = """            // Secure Deletion of Original Media File from System Gallery
            try {
...
new_delete = """            // 4. Resolve the ORIGINAL MediaStore URI
            var resolvedUri = uri
...
vm = vm.replace(old_delete, new_delete)
